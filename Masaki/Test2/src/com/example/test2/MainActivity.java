...
public class MainActivity extends Activity {
	...
	private Button.OnClickListener btn1Listener = new Button.OnClickListener() {
		...
		public void onClick(View v) {
			...
			// 設定變數值
			myThread.MyData = ed1.getText().toString();
			// 開始執行緒
			myThread.start();
		}
	};
	...
	class HttpThread extends Thread {
		...
		// 宣告變數並指定預設值
		public String MyData = "NoData";
		public String Url = "http://www.tui-na.com.tw/MyDataTest.php";
		...
		public void run() {
			...
			try {
				...
				// 逐一增加POST所需的Key、值
				parmas.add(new BasicNameValuePair("MyData", this.MyData));
