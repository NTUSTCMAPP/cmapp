...
public class ClothListView_BaeAdater extends BaseAdapter {
	...
	public void setKind(String string){//設定分類
		...
		}else if(sort.equals("catalog")){
			length=myactivity.getResources().getInteger(R.integer.catalogSum);
			kind= new String[length];
			kind=myactivity.getResources().getStringArray(R.array.catalogName);
			TypedArray images = myactivity.getResources().obtainTypedArray(R.array.catalog_images);
	...
	public Object getItem(int position) {
		// TODO Auto-generated method stub
		if(sort.equals("cloth")||sort.equals("pants")||sort.equals("shoes")||sort.equals("brand")||sort.equals("catalog")||sort.equals("accessory")){
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(sort.equals("cloth")||sort.equals("pants")||sort.equals("shoes")||sort.equals("accessory")){
			...
			img.setOnTouchListener( new ImageView.OnTouchListener(){
					...
					public boolean onTouch(View v, MotionEvent event) {
						// TODO Auto-generated method stub
						ClipData data = ClipData.newPlainText("catalog",
								String.valueOf(position) );
						v.startDrag(data, new DragShadowBuilder(v), v, 0);
						return true;
					}
