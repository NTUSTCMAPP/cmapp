...
public class nicknameFragment extends ListFragment  implements OnItemClickListener{
	public void onActivityCreated(Bundle savedInstanceState){
		super.onActivityCreated(savedInstanceState);
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_list_item_1, People.NICKNAME);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		ageText.setText(People.FAKEAGE[position]);
