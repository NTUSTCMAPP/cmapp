...
public class multiTouch extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //  LL =(RelativeLayout)findViewById(R.id.imgLayout);
        ...
        info=(TextView)findViewById(R.id.MultiTouchinfo);
    ...
    private ImageView.OnTouchListener touchListener =new ImageView.OnTouchListener(){
		...
		public boolean onTouch(View v, MotionEvent event) {
		                ...
		                if (mode == DRAG) {
		                    ...
		                    if (newDist > 30f && event.getPointerCount() == 2) {
		                      //  matrix.set(savedMatrix);
		                        ...
		                        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) view.getLayoutParams();
		                        if(scale>=1){
			                        layoutParams.width=(int) (layoutParams.width+5* scale);
			                        layoutParams.height=(int) (layoutParams.height + 5* scale);
			                        Log.d("myLog", "W:"+ layoutParams.width +"H:"+ layoutParams.height);
			                        view.setLayoutParams(layoutParams);
		                        
		                       }else if(scale<1 && layoutParams.width>=100 && layoutParams.height>=100){
		    ...
		    //    view.setImageMatrix(matrix);
		        ...
		        info.setText("W:"+width+"H:"+height+"T:"+topmargin+"L:"+leftmargin+"R:"+ro);
